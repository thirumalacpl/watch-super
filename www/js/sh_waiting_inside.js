...
$('.waiting_imagec').append('<img src="http://thewatchguard.com/alpha/uploads/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneo+'two');
$('.waiting_imageb').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 2){
  var oneoo=oneemploy[k];
//alert(oneoo+'3');
$('.waiting_imagea').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 3){
  var oneooo=oneemploy[k];
// alert(oneooo+'4');
$('.waiting_imaged').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 4){
  var oner=oneemploy[k];
// alert(oner+'5');
$('.waiting_imagee').append('<img src="http://thewatchguard.com/alpha/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( k == 5){
  var oner=oneemploy[k];
// alert(oner+'6');
$('.waiting_imagef').append('<img src="http://thewatchguard.com/alpha/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
$('.waiting_imagec').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
}
...
//alert(oneo+'two');
$('.waiting_imagea').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneoo+'3');
$('.waiting_imageb').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneooo+'4');
$('.waiting_imaged').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( j == 4){
  var oner=oneaddress[j];
// alert(oner+'5');
$('.waiting_imagee').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 5){
  var oner=oneaddress[j];
//alert(oner+'6');
$('.waiting_imagef').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
