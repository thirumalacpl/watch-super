...
$('.approved_shb').append('<img src="http://thewatchguard.com/alpha/uploads/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneo+'two');
$('.approved_shd').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 2){
  var oneoo=oneemploy[k];
//alert(oneoo+'3');
$('.approved_shc').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 3){
  var oneooo=oneemploy[k];
// alert(oneooo+'4');
$('.approved_sha').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( k == 4){
  var oner=oneemploy[k];
// alert(oner+'5');
$('.approved_she').append('<img src="http://thewatchguard.com/alpha/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( k == 5){
  var oner=oneemploy[k];
// alert(oner+'6');
$('.approved_shf').append('<img src="http://thewatchguard.com/alpha/uploads/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 0){
  var one=oneemp[j];
//alert(one+'one');
$('.approved_shc').append('<img src="http://thewatchguard.com/alpha/uploads/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 1){
  var oneo=oneemp[j];
//alert(oneo+'two');
$('.approved_shad').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( j == 2){
  var oneoo=oneemp[j];
//alert(oneoo+'3');
$('.approved_shb').append('<img src="http://thewatchguard.com/alpha/uploads/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
$('.approved_shc').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+one+'" alt="Band"  class="rondell-item-image rondell-item-resizeable">');
}
...
//alert(oneo+'two');
$('.approved_shd').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneoo+'3');
$('.approved_shb').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneoo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
//alert(oneooo+'4');
$('.approved_sha').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oneooo+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');

}
if ( j == 4){
  var oner=oneaddress[j];
// alert(oner+'5');
$('.approved_she').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
...
if ( j == 5){
  var oner=oneaddress[j];
//alert(oner+'6');
$('.approved_shf').append('<img src="http://thewatchguard.com/alpha/documents/addressid/'+oner+'" alt="Band" class="rondell-item-image rondell-item-resizeable">');
